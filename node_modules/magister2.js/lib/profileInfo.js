...
class ProfileInfo extends _magisterThing2.default {
  ...
  */
	getProfilePicture() {
		...
		var personUrl = `${this._magister.school.url}/api/personen/${this.id}`
		var photoUrl = `${personUrl}/foto?width=${width}&height=${height}&crop=${crop}`;
		return this._magister.http.get(photoUrl).then(function (res) {
			return res.body;
		});
	}
