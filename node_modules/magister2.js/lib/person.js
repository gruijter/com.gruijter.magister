 ...
 * @private
 */
class Person extends _magisterThing2.default {
	/**
  ...
  */
	getFilled(type) {
		...
		return this._magister.persons(this.fullName, type).then(function (persons) {
			return persons[0] || _this;
		});
	}
  ...
  */
	toJSON() {
		var obj = _lodash2.default.omit(super.toJSON(), '_filled');
		delete obj._type;
		return obj;
	}
