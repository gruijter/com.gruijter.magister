...
class File extends _magisterThing2.default {
  ...
  */
   ...
   */
		...
		const selfUrl = _lodash2.default.find(raw.Links, { Rel: 'Self' });
		const contentUrl = _lodash2.default.find(raw.Links, { Rel: 'Contents' });
		const getUrl = link => !link ? null : _url2.default.resolve(magister.school.url, link.Href);
