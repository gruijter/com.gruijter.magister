(function() {
  var _, messageFolder, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, request, root, wrapCallback,
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    slice = [].slice;

  root = (ref = typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? ref : this.Magister != null ? this.Magister : this.Magister = {};
  ...
  root.Appointment = (function() {
    ...
    Appointment.prototype._toMagisterStyle = function() {
      ...
      obj.Docenten = (function() {
        ...
        for (j = 0, len = ref1.length; j < len; j++) {
          p = ref1[j];
          results1.push(p._toMagisterStyle());
        }
        return results1;
      }).call(this);
      obj.Vakken = (function() {
    ...
    Appointment._convertRaw = function(magisterObj, raw) {
      var c, obj, p, ref1, ref2, ref3, ref4;
      ...
      obj._description = (ref1 = raw.Omschrijving) != null ? ref1 : "";
      obj._location = (ref2 = raw.Lokatie) != null ? ref2 : "";
      ...
      obj._teachers = raw.Docenten != null ? (function() {
        ...
        for (j = 0, len = ref3.length; j < len; j++) {
          p = ref3[j];
          results1.push(root.Person._convertRaw(magisterObj, p));
        }
        return results1;
      })() : [];
      ...
      obj._scrapped = (ref3 = raw.Status) === 4 || ref3 === 5;
      obj._changed = (ref4 = raw.Status) === 3 || ref4 === 9 || ref4 === 10;
      return obj;
    };
  ...
  root.AbsenceInfo = (function() {
    ...
    AbsenceInfo._convertRaw = function(magisterObj, raw) {
      ...
      obj._description = (ref1 = (ref2 = raw.Omschrijving) != null ? ref2.trim() : void 0) != null ? ref1 : '';
      obj._type = raw.Verantwoordingtype;
      obj._code = (ref3 = raw.Code) != null ? ref3 : '';
  ...
  root = (ref1 = typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? ref1 : this.Magister != null ? this.Magister : this.Magister = {};
  ...
  root.Assignment = (function() {
    ...
    Assignment.prototype.versions = function(callback) {
      var id, j, len, pushResult, ref2, results1;
      pushResult = root._helpers.asyncResultWaiter(this._versionIds.length, function(r) {
        return callback(null, r);
      });
      ref2 = this._versionIds;
      results1 = [];
      for (j = 0, len = ref2.length; j < len; j++) {
        id = ref2[j];
        results1.push(this._magisterObj.http.get(this._magisterObj._personUrl + "/opdrachten/versie/" + id, {}, (function(_this) {
          return function(error, result) {
            if (error != null) {
    ...
    Assignment._convertRaw = function(magisterObj, raw) {
      ...
      obj._files = (function() {
        ...
        for (j = 0, len = ref2.length; j < len; j++) {
          f = ref2[j];
          results1.push(root.File._convertRaw(magisterObj, void 0, f));
        }
        return results1;
      })();
      obj._teachers = raw.Docenten != null ? (function() {
  ...
  root = (ref2 = typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? ref2 : this.Magister != null ? this.Magister : this.Magister = {};
  ...
  root.Class = (function() {
    ...
    Class._convertRaw = function(magisterObj, raw) {
      var obj, ref3, ref4, ref5, ref6;
      obj = new root.Class(magisterObj);
      obj._id = (ref3 = raw.id) != null ? ref3 : raw.Id;
      obj._beginDate = root._helpers.parseDate(raw.begindatum);
      obj._endDate = root._helpers.parseDate(raw.einddatum);
      obj._abbreviation = (ref4 = raw.afkorting) != null ? ref4 : raw.Afkorting;
      obj._description = (ref5 = raw.omschrijving) != null ? ref5 : raw.Omschrijving;
      obj._number = (ref6 = raw.volgnr) != null ? ref6 : raw.Volgnr;
  ...
  root.Course = (function() {
    function Course(_magisterObj) {
      this._magisterObj = _magisterObj;
      this.getOtherTutors = bind(this.getOtherTutors, this);
        ...
        return function(error, result) {
          ...
          if (error != null) {
            ...
            return callback(null, (function() {
              var j, len, ref3, results1;
              ref3 = JSON.parse(result.content);
              results1 = [];
              for (j = 0, len = ref3.length; j < len; j++) {
                c = ref3[j];
                results1.push(root.Class._convertRaw(this._magisterObj, c));
              }
              return results1;
            }).call(_this));
          }
      ...
      return this._magisterObj.http.get(this._periodsUrl, {}, (function(_this) {
        return function(error, result) {
          ...
          if (error != null) {
            ...
            return callback(null, (function() {
              var j, len, ref3, results1;
              ref3 = JSON.parse(result.content).Items;
              results1 = [];
              for (j = 0, len = ref3.length; j < len; j++) {
                p = ref3[j];
                results1.push(root.GradePeriod._convertRaw(this._magisterObj, p));
              }
              return results1;
            }).call(_this));
          }
    ...
    Course.prototype.grades = function() {
      var callback, fillGrade, fillPersons, onlyRecent, options, ref3;
      options = (ref3 = _.find(arguments, function(a) {
      ...
      return this._magisterObj.http.get((onlyRecent ? this._gradesUrlPrefix : this._gradesUrl), {}, (function(_this) {
        return function(error, result) {
          var j, len, pushResult, raw, results1;
          if (error != null) {
            return callback(error, null);
          } else {
            ...
            pushResult = root._helpers.asyncResultWaiter(result.length, function(r) {
              _.chain(r).uniq(function(g) {
                ...
                var g, j, len, ref4, results1;
                ref4 = _.filter(r, function(g) {
                  return g["class"]().id === c.id;
                });
                results1 = [];
                for (j = 0, len = ref4.length; j < len; j++) {
                  g = ref4[j];
                  results1.push(g._class = c);
                }
                return results1;
              });
            ...
            for (j = 0, len = result.length; j < len; j++) {
              raw = result[j];
              results1.push((function(raw) {
                var g, push, ref4;
                g = root.Grade._convertRaw(_this._magisterObj, raw);
                g._columnUrl = _this._columnUrlPrefix + ((ref4 = raw.CijferKolom) != null ? ref4.Id : void 0);
          ...
          if (error != null) {
            ...
            return callback(null, (function() {
              ...
              for (j = 0, len = items.length; j < len; j++) {
                p = items[j];
                results1.push(root.Person._convertRaw(this._magisterObj, p));
              }
              return results1;
            }).call(_this));
          }
    ...
    Course._convertRaw = function(magisterObj, raw) {
      ...
      obj._group = {
        id: raw.Groep.Id,
        description: (group = raw.Groep.Omschrijving, group != null ? (ref3 = _.find(group.split(' '), function(str) {
          return /\d/.test(str);
        })) != null ? ref3 : group : void 0),
        locationId: raw.Groep.LocatieId
      };
      obj._profile = raw.Profiel;
      obj._alternativeProfile = raw.Profiel2;
      obj._current = (obj._begin.getTime() <= (ref4 = _.now()) && ref4 <= obj._end.getTime());
      return obj;
    };
  ...
  root = (ref3 = typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? ref3 : this.Magister != null ? this.Magister : this.Magister = {};
  ...
  root.DigitalSchoolUtility = (function() {
    ...
    DigitalSchoolUtility._convertRaw = function(magisterObj, raw) {
      ...
      obj._url = (ref4 = _.find(raw.Links, function(l) {
        return l.Rel === 'content';
      })) != null ? ref4.Href : void 0;
  ...
  root = (ref4 = typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? ref4 : this.Magister != null ? this.Magister : this.Magister = {};
  ...
  root.FileFolder = (function() {
    ...
    FileFolder.prototype.files = function(callback) {
      return this._magisterObj.http.get(this._magisterObj._personUrl + "/bronnen?parentId=" + (this.id()), {}, (function(_this) {
        return function(error, result) {
          var f, files, j, len, pushResult, results1;
          if (error != null) {
            return callback(error, null);
          } else {
            files = (function() {
              var j, len, ref5, results1;
              ref5 = JSON.parse(result.content).Items;
              results1 = [];
              for (j = 0, len = ref5.length; j < len; j++) {
                f = ref5[j];
                results1.push(root.File._convertRaw(this._magisterObj, this, f));
              }
              return results1;
            }).call(_this);
  ...
  root.File = (function() {
    ...
    File.prototype.download = function() {
      var callback, fileName, fs, ref5, req, request;
      fileName = (ref5 = _.find(arguments, function(a) {
    ...
    File._convertRaw = function(magisterObj, fileFolder, raw) {
      var addedBy, l, obj, ref5, ref6, ref7;
      ...
      obj._rights = raw.Privilege;
      obj._mime = raw.ContentType || 'application/octet-stream';
      obj._changedDate = root._helpers.parseDate(raw.GewijzigdOp);
      obj._creationDate = root._helpers.parseDate((ref5 = raw.GemaaktOp) != null ? ref5 : raw.Datum);
      obj._addedBy = addedBy;
      obj._fileBlobId = (ref6 = raw.FileBlobId) != null ? ref6.toString() : void 0;
      obj._fileFolder = fileFolder;
      obj._uniqueId = raw.UniqueId;
      obj._referenceId = (ref7 = raw.Referentie) != null ? ref7.toString() : void 0;
      l = _.find(raw.Links, {
        Rel: 'Contents'
      });
      if (l == null) {
  ...
  root = (ref5 = typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? ref5 : this.Magister != null ? this.Magister : this.Magister = {};
  ...
  root.Grade = (function() {
        ...
        return this._magisterObj.http.get(this._columnUrl, {}, (function(_this) {
          return function(error, result) {
            ...
            if (error != null) {
              ...
              _this._description = (ref6 = result.WerkInformatieOmschrijving) != null ? ref6 : "";
              _this._weight = Number(result.Weging);
              if (_.isNaN(_this._weight)) {
                _this._weight = 0;
              }
              _this._type._level = result.KolomNiveau;
              _this._type._description = (ref7 = result.KolomOmschrijving) != null ? ref7 : "";
              _this._filled = true;
    ...
    Grade._convertRaw = function(magisterObj, raw) {
      var obj, period, ref6, ref7, ref8, val;
      ...
      obj._period = (period = new root.GradePeriod(magisterObj), period._id = raw.CijferPeriode.Id, period._name = (ref6 = raw.CijferPeriode.Naam) != null ? ref6 : "", period);
      obj._class = {
        id: raw.Vak.Id,
        abbreviation: (ref7 = raw.Vak.Afkorting) != null ? ref7 : "",
        description: (ref8 = raw.Vak.Omschrijving) != null ? ref8 : ""
      };
  ...
  root.GradeType = (function() {
    function GradeType(_magisterObj) {
      ...
      this.isEnd = function() {
        var ref6;
        return (ref6 = this.type()) === 2 || ref6 === 13;
      };
    }
  ...
  root.GradePeriod = (function() {
    ...
    GradePeriod._convertRaw = function(magisterObj, raw) {
      ...
      obj._begin = root._helpers.parseDate(raw.Start);
      obj._end = root._helpers.parseDate(raw.Einde);
      obj._name = (ref6 = raw.Naam) != null ? ref6 : "";
      obj._description = (ref7 = raw.Omschrijving) != null ? ref7 : "";
      return obj;
    };
  ...
  root = (ref6 = typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? ref6 : this.Magister != null ? this.Magister : this.Magister = {};
  ...
  root.Magister = (function() {
    function Magister() {
      ...
      if (_.isString(this.magisterSchool)) {
        ...
        if (!((this.magisterSchool.url != null) && this.magisterSchool.url.search(/https?:\/\//) === 0)) {
          throw new Error("Invalid url given: '" + this.magisterSchool.url + "'");
        }
        if (options.login) {
    ...
    Magister.prototype.appointments = function() {
      var callback, dateConvert, dates, fillPersons, from, ignoreAbsenceErrors, ref7, ref8, to, url;
      callback = _.find(arguments, function(a) {
        return _.isFunction(a);
      });
      ref7 = _.filter(arguments, function(a) {
        return _.isBoolean(a);
      }), fillPersons = ref7[0], ignoreAbsenceErrors = ref7[1];
      if (fillPersons == null) {
        fillPersons = false;
      }
      ...
      ref8 = _.sortBy(dates), from = ref8[0], to = ref8[1];
      if (to == null) {
        to = from;
      }
      ...
      return this.http.get(url, {}, (function(_this) {
        return function(error, result) {
          var a, absenceInfo, appointments, finish, j, len, pushResult, results1;
          if (error != null) {
            return callback(error, null);
          } else {
            result = JSON.parse(result.content);
            appointments = (function() {
              var j, len, ref9, results1;
              ref9 = result.Items;
              results1 = [];
              for (j = 0, len = ref9.length; j < len; j++) {
                a = ref9[j];
                results1.push(root.Appointment._convertRaw(this, a));
              }
              return results1;
            }).call(_this);
            absenceInfo = null;
    ...
    Magister.prototype.createAppointment = function(options, callback) {
      var content, j, key, len, payload, ref10, ref7, ref8, ref9, required, start;
      this._forceReady();
      ...
      payload = {
        ...
        Lokatie: (ref7 = options.location) != null ? ref7 : '',
        Inhoud: (content = (ref8 = options.content) != null ? ref8.trim() : void 0, (content != null) && content.length > 0 ? _.escape(options.content) : null),
        Type: (ref9 = options.type) != null ? ref9 : 1,
        DuurtHeleDag: (ref10 = options.fullDay) != null ? ref10 : false,
        InfoType: 0,
        WeergaveType: 1,
        Status: 2,
        HeeftBijlagen: false,
        ...
        return function(e, r) {
          ...
          if (e != null) {
            ...
            _this._messageFolders = (function() {
              var j, len, ref7, results1;
              ref7 = JSON.parse(r.content).Items;
              results1 = [];
              for (j = 0, len = ref7.length; j < len; j++) {
                m = ref7[j];
                results1.push(root.MessageFolder._convertRaw(this, m));
              }
              return results1;
            }).call(_this);
        ...
        return function(error, result) {
          ...
          if (error != null) {
            ...
            converted = (function() {
              ...
              for (j = 0, len = ref7.length; j < len; j++) {
                c = ref7[j];
                results1.push(root.Course._convertRaw(this, c));
              }
              return results1;
            }).call(_this);
    ...
    Magister.prototype.getLimitedCurrentCourseInfo = function(callback) {
      ...
      return this.http.get(url, {}, function(error, result) {
        var e, error1, group, parsed, ref7, ref8, ref9;
        if (error != null) {
          return callback(error, null);
        } else {
          try {
            ...
            return callback(null, {
              group: (group = parsed.Klas, group != null ? (ref7 = _.find(group.split(' '), function(str) {
                return /\d/.test(str);
              })) != null ? ref7 : group : void 0),
              profile: parsed.Profielen,
              pupilId: parsed.StamNr,
              type: {
                year: +((ref8 = /\d+/.exec(parsed.Studie)) != null ? ref8[0] : void 0),
                schoolVariant: (ref9 = /[^\d\s]+/.exec(parsed.Studie)) != null ? ref9[0] : void 0
              }
            });
          } catch (error1) {
            e = error1;
    ...
    Magister.prototype.getPersons = function() {
      var b1, b2, callback, query, queryType, ref7, type, url, val;
      this._forceReady();
      ref7 = _.filter(arguments, function(a) {
        return _.isString(a);
      }), query = ref7[0], type = ref7[1];
      callback = _.find(arguments, function(a) {
        return _.isFunction(a);
      });
        ...
        this.http.get(url, {}, (function(_this) {
          return function(error, result) {
            ...
            if (error != null) {
              ...
              result = (function() {
                var j, len, ref8, results1;
                ref8 = JSON.parse(result.content).Items;
                results1 = [];
                for (j = 0, len = ref8.length; j < len; j++) {
                  p = ref8[j];
                  results1.push(root.Person._convertRaw(this, p));
                }
                return results1;
              }).call(_this);
    ...
    Magister.prototype.fillPersons = function(persons, callback, overwriteType) {
      var error1, error2, j, len, p, pushResult, ref7, ref8;
      this._forceReady();
      if (_.isArray(persons)) {
        ...
        for (j = 0, len = persons.length; j < len; j++) {
          p = persons[j];
          try {
            this.getPersons(_.last(p.fullName().split(" ")), (ref7 = p._type) != null ? ref7 : overwriteType, function(e, r) {
              var ref8;
              return pushResult((ref8 = r[0]) != null ? ref8 : p);
            });
          } catch (error1) {
            pushResult(p);
          }
        ...
        try {
          this.getPersons(_.last(persons.fullName().split(" ")), (ref8 = persons._type) != null ? ref8 : overwriteType, function(e, r) {
            var ref9;
            return callback(null, (ref9 = r[0]) != null ? ref9 : persons);
          });
        } catch (error2) {
    ...
    Magister.prototype.composeAndSendMessage = function() {
      var body, callback, m, recipients, ref7, subject;
      this._forceReady();
      ref7 = _.filter(arguments, _.isString), subject = ref7[0], body = ref7[1];
      ...
      return this.http.get(this._personUrl + "/bronnen?soort=0", {}, (function(_this) {
        return function(error, result) {
          ...
          if (error != null) {
            ...
            return callback(null, (function() {
              var j, len, ref7, results1;
              ref7 = JSON.parse(result.content).Items;
              results1 = [];
              for (j = 0, len = ref7.length; j < len; j++) {
                f = ref7[j];
                results1.push(root.FileFolder._convertRaw(this, f));
              }
              return results1;
            }).call(_this));
          }
    ...
    Magister.prototype.studyGuides = function(callback) {
      var cb, fillClass, ref7;
      this._forceReady();
      fillClass = (ref7 = _.find(arguments, function(a) {
        return _.isBoolean(a);
      })) != null ? ref7 : true;
      callback = _.find(arguments, function(a) {
        return _.isFunction(a);
          ...
          return _this.http.get(_this._pupilUrl + "/studiewijzers?peildatum=" + (root._helpers.urlDateConvert(new Date)), {}, function(error, result) {
            ...
            if (error != null) {
              ...
              result = (function() {
                ...
                for (j = 0, len = ref8.length; j < len; j++) {
                  s = ref8[j];
                  results1.push(root.StudyGuide._convertRaw(this, s));
                }
                return results1;
              }).call(_this);
              fn = function(studyGuide) {
                if (classes != null) {
    ...
    Magister.prototype.assignments = function() {
      var amount, callback, cb, fillClass, fillPersons, ref7, ref8, skip;
      this._forceReady();
      ref7 = _.filter(arguments, function(a) {
        return _.isNumber(a);
      }), amount = ref7[0], skip = ref7[1];
      ref8 = _.filter(arguments, function(a) {
        return _.isBoolean(a);
      }), fillPersons = ref8[0], fillClass = ref8[1];
      callback = _.find(arguments, function(a) {
        return _.isFunction(a);
      });
      if (callback == null) {
      ...
      cb = (function(_this) {
        return function(classes) {
          return _this.http.get(_this._personUrl + "/opdrachten?skip=" + skip + "&top=" + amount + "&status=alle", {}, function(error, result) {
            var e, id, j, len, pushResult, results1;
            if (error != null) {
              return callback(error, null);
            } else {
              result = (function() {
                var j, len, ref9, results1;
                ref9 = JSON.parse(result.content).Items;
                results1 = [];
                for (j = 0, len = ref9.length; j < len; j++) {
                  e = ref9[j];
                  results1.push(e.Id);
              ...
              for (j = 0, len = result.length; j < len; j++) {
                id = result[j];
                results1.push(_this.http.get(_this._personUrl + "/opdrachten/" + id, {}, function(error, result) {
                  var assignment, ref9, teachers;
                  ...
                  if (fillPersons) {
                    teachers = (ref9 = assignment.teachers()) != null ? ref9 : [];
                    return _this.fillPersons(teachers, (function(e, r) {
    ...
    Magister.prototype.digitalSchoolUtilities = function() {
      var callback, fillClass, ref7, url;
      this._forceReady();
      fillClass = (ref7 = _.find(arguments, function(a) {
        return _.isBoolean(a);
      })) != null ? ref7 : true;
    ...
    Magister.prototype.children = function(callback) {
      return this.http.get(this._personUrl + "/kinderen", {}, (function(_this) {
        return function(error, result) {
          var info, j, len, m, parsed, raw, ref7, res;
          if (error != null) {
            return callback(error, null);
          } else {
            parsed = JSON.parse(result.content);
    ...
    Magister.prototype._setReady = function() {
      var callback, j, len, ref7;
      this._ready = true;
      ref7 = this._readyCallbacks;
      for (j = 0, len = ref7.length; j < len; j++) {
        callback = ref7[j];
        callback();
      }
    ...
    Magister.prototype._setErrored = function(e, statusCode) {
      var callback, error1, j, key, len, parsed, ref7;
      try {
        parsed = JSON.parse(e);
        ...
        this._magisterLoadError.toString = function() {
          var ref7;
          return (ref7 = parsed.message) != null ? ref7 : '';
        };
      } catch (error1) {
  ...
  root = (ref7 = typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? ref7 : this.Magister != null ? this.Magister : this.Magister = {};
  ...
  root.Message = (function() {
    ...
    Message.prototype.addRecipient = function(recipient, type) {
      ...
      if (_.isString(recipient)) {
        ...
        for (j = 0, len = recipient.length; j < len; j++) {
          p = recipient[j];
    ...
    Message.prototype.fillMessage = function() {
      var callback, fillPersons, ref8;
      fillPersons = (ref8 = _.first(arguments)) != null ? ref8 : false;
          ...
          return function(error, result) {
            ...
            if (error != null) {
              ...
              _this._attachments = (function() {
                var j, len, ref10, ref9, results1;
                ref10 = (ref9 = parsed.Bijlagen) != null ? ref9 : [];
                results1 = [];
                for (j = 0, len = ref10.length; j < len; j++) {
                  a = ref10[j];
                  results1.push(root.File._convertRaw(this._magisterObj, void 0, a));
                }
                return results1;
              }).call(_this);
              if (fillPersons) {
    ...
    Message._convertRaw = function(magisterObj, raw) {
      ...
      obj._id = raw.Id;
      obj._body = (ref8 = raw.Inhoud) != null ? ref8 : "";
      ...
      obj._recipients = (function() {
        var j, len, ref10, ref9, results1;
        ref10 = (ref9 = raw.Ontvangers) != null ? ref9 : [];
        results1 = [];
        for (j = 0, len = ref10.length; j < len; j++) {
          o = ref10[j];
          results1.push(root.Person._convertRaw(magisterObj, o));
        }
        return results1;
      })();
  ...
  root = (ref8 = typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? ref8 : this.Magister != null ? this.Magister : this.Magister = {};
  ...
  root.MessageFolder = (function() {
    ...
    MessageFolder.prototype.messages = function() {
      ...
      return this._magisterObj.http.get(url, {}, (function(_this) {
        return function(error, result) {
          var fn, j, k, len, len1, m, messages, pushMessage;
          if (error != null) {
            callback(error, null);
          } else {
            messages = (function() {
              ...
              for (j = 0, len = ref9.length; j < len; j++) {
                m = ref9[j];
                results1.push(root.Message._convertRaw(this._magisterObj, m));
              }
              return results1;
            }).call(_this);
    ...
    MessageFolder.prototype.messageFolders = function(query, callback) {
      var ref9;
      callback = (ref9 = (callback != null ? callback : query)) != null ? ref9 : (function() {});
      if (callback == null) {
        return;
      }
        ...
        return function(error, result) {
          ...
          if (error != null) {
            ...
            messageFolders = (function() {
              var j, len, ref10, results1;
              ref10 = JSON.parse(result.content).Items;
              results1 = [];
              for (j = 0, len = ref10.length; j < len; j++) {
                mF = ref10[j];
                results1.push(root.MessageFolder._convertRaw(this._magisterObj, mF));
              }
              return results1;
            }).call(_this);
  ...
  root = (ref9 = typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? ref9 : this.Magister != null ? this.Magister : this.Magister = {};
  ...
  root.Person = (function() {
    ...
    Person._convertRaw = function(magisterObj, raw, type) {
      ...
      obj._description = (ref10 = (ref11 = raw.Omschrijving) != null ? ref11 : raw.Naam) != null ? ref10 : raw.naam;
  ...
  root = (ref10 = typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? ref10 : this.Magister != null ? this.Magister : this.Magister = {};
    ...
    function ProfileInfo(_magisterObj, _firstName, _lastName, _birthDate) {
      ...
      this.fullName = function() {
        if (this.namePrefix() === null) {
          ...
          return (this.firstName()) + " " + (this.namePrefix()) + " " + (this.lastName());
        }
      };
  ...
  root = (ref11 = typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? ref11 : this.Magister != null ? this.Magister : this.Magister = {};
  ...
  root.MagisterSchool = (function() {
    ...
    /**
    	 ...
    	 * @type String
     */
    function MagisterSchool(id1, name1, url1) {
      this.id = id1;
      this.name = name1;
      this.url = url1;
    }
      ...
      return new root.MagisterHttp().get("https://mijn.magister.net/api/schools?filter=" + query, {}, (function(_this) {
        return function(error, result) {
          ...
          if (error != null) {
            ...
            return callback(null, (function() {
              var j, len, ref12, results1;
              ref12 = JSON.parse(result.content);
              results1 = [];
              for (j = 0, len = ref12.length; j < len; j++) {
                s = ref12[j];
                results1.push(this._convertRaw(s));
              }
              return results1;
            }).call(_this));
          }
  ...
  root = (ref12 = typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? ref12 : this.Magister != null ? this.Magister : this.Magister = {};
  ...
  root.StudyGuide = (function() {
    ...
    StudyGuide.prototype.parts = function(callback) {
      ...
      return this._magisterObj.http.get(this._magisterObj._pupilUrl + "/studiewijzers/" + (this.id()), {}, (function(_this) {
        return function(error, result) {
          var id, j, len, p, pushResult, ref13, results1;
          if (error != null) {
            return callback(error, null);
          } else {
            ...
            for (j = 0, len = ref13.length; j < len; j++) {
              id = ref13[j];
              results1.push(_this._magisterObj.http.get(_this._magisterObj._pupilUrl + "/studiewijzers/" + (_this.id()) + "/onderdelen/" + id, {}, function(error, result) {
                var parsed, part;
                if (error != null) {
                  return callback(error, null);
                } else {
  ...
  root.StudyGuidePart = (function() {
    ...
    StudyGuidePart._convertRaw = function(magisterObj, raw) {
      ...
      obj._to = root._helpers.parseDate(raw.TotEnMet);
      obj._name = raw.Titel;
      obj._description = (ref13 = raw.Omschrijving) != null ? ref13 : "";
      obj._visible = raw.IsZichtbaar;
      obj._number = raw.Volgnummer;
      obj._files = (function() {
        var j, len, ref14, results1;
        ref14 = raw.Bronnen;
        results1 = [];
  ...
  root = (ref13 = typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? ref13 : this.Magister != null ? this.Magister : this.Magister = {};
  ...
  root._helpers = (function() {
    ...
    _helpers.defer = function() {
      ...
      if ((typeof Meteor !== "undefined" && Meteor !== null ? Meteor.defer : void 0) != null) {
        ...
        _.defer.apply(_, [callback].concat(slice.call(args)));
      }
      return void 0;
    };
  ...
  root = (ref14 = typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? ref14 : this.Magister != null ? this.Magister : this.Magister = {};
