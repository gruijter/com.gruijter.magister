...
class AssignmentVersion extends _magisterThing2.default {
  ...
  */
   ...
   * @readonly
   */
		this.handedInFiles = raw.LeerlingBijlagen.map(f => new _file2.default(magister, undefined, f));
		/**
   * @type {File[]}
   * @readonly
   */
		this.feedbackFiles = raw.FeedbackBijlagen.map(f => new _file2.default(magister, undefined, f));
		/**
   * @type {Date}
   * @readonly
   */
