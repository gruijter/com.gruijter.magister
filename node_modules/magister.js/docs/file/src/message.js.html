...
<head>
  ...
  <title data-ice="title">src/message.js | magister.js</title>
...
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">/* global dedent */
