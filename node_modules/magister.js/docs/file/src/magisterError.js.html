...
<head>
  ...
  <title data-ice="title">src/magisterError.js | magister.js</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">src/magisterError.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">class MagisterError extends Error {
	/**
	 * @private
	 * @param {Object} raw
	 */
