...
<head>
  ...
  <title data-ice="title">src/util.js | magister.js</title>
...
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">export * from &apos;./utils/common&apos;
