...
<head>
  ...
  <title data-ice="title">Home | magister.js</title>
...
<div class="content" data-ice="content"><div data-ice="index" class="github-markdown"><p><a href="http://simplyGits.github.io/MagisterJS/"><img src="http://i.imgur.com/Lrg80ax.png" width="200"></a></p>
<p></p><p>
    <a href="https://travis-ci.org/simplyGits/MagisterJS">
        <img src="https://api.travis-ci.org/simplyGits/MagisterJS.png?branch=master">
    </a>
</p>

<p></p>
<hr>
<p><a href="https://gitter.im/simplyGits/MagisterJS?utm_source=badge&amp;utm_medium=badge&amp;utm_campaign=pr-badge"><img src="https://badges.gitter.im/simplyGits/MagisterJS.svg" alt="Gitter"></a>
<a href="https://badge.fury.io/js/magister.js"><img src="https://badge.fury.io/js/magister.js.svg" alt="npm version"></a>
<a href="https://snyk.io/test/github/simplyGits/MagisterJS?targetFile=package.json"><img src="https://snyk.io/test/github/simplyGits/MagisterJS/badge.svg?targetFile=package.json" alt="Known Vulnerabilities"></a>
<a href="https://www.codefactor.io/repository/github/simplygits/magisterjs"><img src="https://www.codefactor.io/repository/github/simplygits/magisterjs/badge" alt="CodeFactor"></a></p>
<p>A JavaScript implementation of the <a href="http://magister6.nl/">Magister 6</a> API.</p>
<h1 id="quickstart">Quickstart</h1><p><code>npm install magister.js</code></p>
<pre><code class="lang-javascript"><code class="source-code prettyprint">const { default: magister, getSchools } = require(&apos;magister.js&apos;);
// or with es6 modules:
...
<h1 id="useful-links">Useful links</h1><ul>
<li><a href="http://simplyGits.github.io/MagisterJS/">Documentation</a></li>
</ul>
<h1 id="before-creating-issues">Before creating issues</h1><ol>
<li>Update all your packages with <code>npm update</code></li>
<li>Be sure you haven&apos;t made a typo and your code is correct (check the <a href="http://simplyGits.github.io/MagisterJS/docs/index.html">docs</a>)</li>
<li>Don&apos;t create issues which occur in a modified version</li>
</ol>
<h1 id="contributing">Contributing</h1><ul>
<li>Document your code using <a href="http://usejsdoc.org/">jsdoc</a></li>
<li>Respect and follow the current programming style</li>
<li>Test your changes with <code>npm test</code></li>
<li>Check your code style with <code>eslint</code></li>
<li>Only commit the <code>src/</code> and <code>test/</code> directory</li>
</ul>
<h1 id="license">License</h1><p><a href="LICENSE">LGPLv3</a></p>
</div>
</div>
